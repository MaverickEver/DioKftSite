...
namespace DioKftSite.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,ParentId,Name")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,ParentId,Name")] Category category)
        {
            if (ModelState.IsValid)
            {
